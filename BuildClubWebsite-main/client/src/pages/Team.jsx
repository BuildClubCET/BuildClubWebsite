  ...
  return (
    <>
        ...
        <div className=" h-full bg-[#04131a] ">
          <div className="grid grid-cols-3 grid-rows-1 ">
            <div className="text-white col-span-2 w-full p-16">
              ...
              The CET Build Club is a dynamic and tech-focused community where
              students collaborate on innovative projects, ranging from AI and
            ...
            <div className="text-white p-8 h-32 w-32">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1239.5025885171574!2d76.90607098767227!3d8.545771266330258!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05bec79541c519%3A0x98324eb5aafb3778!2sCollege%20of%20Engineering%20Trivandrum%20(CET)!5e0!3m2!1sen!2sin!4v1726547831627!5m2!1sen!2sin" 
              width="300" 
              height="250" 
              loading="lazy" 
      ...
      <footer className="bg-[#04131a]">
        <div className="bg-[#04131a] w-full max-w-screen-xl mx-auto  md:py-8">
          <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            {/* Wrapping all icons inside a rounded grey container */}
            <div className="bg-[#d9d9d9] p-4 rounded-3xl flex space-x-6">
              {/* Facebook */}
              <a
                href="#"
                className="text-[#04131a] hover:text-gray-900 dark:hover:text-white"
              >
